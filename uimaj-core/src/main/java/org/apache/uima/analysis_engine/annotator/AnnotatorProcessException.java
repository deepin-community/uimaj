...
public class AnnotatorProcessException extends UIMAException {
   ...
   */
  public AnnotatorProcessException(Throwable aCause) {
    super(aCause);
  }
   ...
   *          arguments.
   */
  public AnnotatorProcessException(String aMessageKey, Object[] aArguments) {
   ...
   *          the original exception that caused this exception to be thrown, if any
   */
  public AnnotatorProcessException(String aMessageKey, Object[] aArguments, Throwable aCause) {
